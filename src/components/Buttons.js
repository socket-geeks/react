      ...
      <>
        <div className="btnContainer">
          <div className="multi-button" style={{ pointerEvents: display }}>
            <button onClick={() => this.props.buttonsHandeler(random1)}>
              {displayBtn && random1}
              {!displayBtn && `wait..`}
            </button>
            <button onClick={() => this.props.buttonsHandeler(random2)}>
              {displayBtn && random2}
              {!displayBtn && `wait..`}
            </button>
            <button onClick={() => this.props.buttonsHandeler(random3)}>
              {displayBtn && random3}
              {!displayBtn && `wait..`}
            </button>
            <button onClick={() => this.props.buttonsHandeler(random4)}>
              {displayBtn && random4}
              {!displayBtn && `wait..`}
            </button>
          </div>
